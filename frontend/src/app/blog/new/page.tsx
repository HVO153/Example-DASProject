                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex justify-center items-center gap-2">
                            <Input
                                ...
                                className={
                                    aiTitle ? "animated-pulse placeholder:opacity-60" : ""
                                }
                                required
                            />
                            {formData.title === "" ? (
                        ...
                        <div className="flex justify-center items-center gap-2">
                            <Input
                                ...
                                className={
                                    aiDescription ? "animated-pulse placeholder:opacity-60" : ""
                                }
                                required
                            />
                            {formData.title === "" ? (
                        ...
                        <Select onValueChange={(value: string) => setFormData({
                            ...
                        ...
                        <div>
                            ...
                            <div className="flex justify-between items-center mb-2">
                                <p className="text-sm text-muted-foreground">
                                    Paste you blog or type here. You can use rich
                                    text forrmatting.
